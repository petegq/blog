...
date: '2023-04-22'
tags: ['AWS', 'NodeJS', 'API', 'Elastic-Beanstalk', 'EB', 'EB-CLI', 'deployment']
draft: false
summary: Deploy your Node.js API to Amazon Web Services (AWS) using the Elastic Beanstalk service
images: []
layout: PostLayout
canonicalUrl: /blog/deploy-nodejs-api-aws-elastic-beanstalk
---
